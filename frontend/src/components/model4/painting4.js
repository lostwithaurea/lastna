...
const Painting4 = () => {
  const data = [
    { name: "Elastomeric Paint", price: 100000 },
  ...
  return (
    ...
    <div style={{fontSize:50, color: "black", fontFamily: "sans-serif"}}>
      ...
      <a className="ed-button" type="button" href="structural4"> Structural Works</a>
      <a className="ed-button" type="button" href="roofing4"> Back</a>
    </div>
    </div>
  );
};
