...
const Structural2 = () => {
  const data = [
    { name: "Wall Materials", price: 620000 },
    { name: "Tiles", price: 60000 },
    { name: "Materials", price: 100000 },
    { name: "Labor", price: 350000 },
  ...
  return (
    ...
    <div style={{fontSize:50, color: "black", fontFamily: "sans-serif"}}>
      ...
      <a className="ed-button" type="button" href="cabinet3"> Cabinet</a>
      <a className="ed-button" type="button" href="painting3"> Back</a>
    </div>
    </div>
  );
};
