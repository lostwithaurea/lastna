...
const Painting2 = () => {
  const data = [
    { name: "Elastomeric Paint", price: 70000 },
    { name: "Woodstain Barnish", price: 54000 },
    { name: "Labor", price: 60000 },
  ...
  return (
    ...
    <div style={{fontSize:50, color: "black", fontFamily: "sans-serif"}}>
      ...
      <a className="ed-button" type="button" href="structural3"> Structural Works</a>
      <a className="ed-button" type="button" href="roofing3"> Back</a>
    </div>
    </div>
  );
};
