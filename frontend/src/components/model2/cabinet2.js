...
const Cabinet2 = () => {
  const data = [
    { name: "Plywood", price: 40000 },
    { name: "Aluminum", price: 48000 },
    { name: "Doors and Jambs", price: 29000 },
  ...
  return (
    ...
    <div style={{fontSize:50, color: "black", fontFamily: "sans-serif"}}>
      ...
      <a className="ed-button" type="button" href="plumbing2"> Plumbing</a>
      <a className="ed-button" type="button" href="structural2"> Back</a>
    </div>
    </div>
  );
};
