...
const Painting5 = () => {
  const data = [
    { name: "Elastomeric Paint", price: 20000 },
    { name: "Woodstain Barnish", price: 20000 },
  ...
  return (
    ...
    <div style={{fontSize:50, color: "black", fontFamily: "sans-serif"}}>
      ...
      <a className="ed-button" type="button" href="structural5"> Structural Works</a>
      <a className="ed-button" type="button" href="roofing5"> Back</a>
    </div>
    </div>
  );
};

export default Painting5;