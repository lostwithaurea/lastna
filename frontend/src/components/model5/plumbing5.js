...
const Plumbing5 = () => {
  const data = [
    { name: "Fixtures", price: 20000 },
    { name: "Materials", price: 13000 },
    { name: "Labor", price: 38000 },
  ...
  return (
    ...
    <div style={{fontSize:50, color: "black", fontFamily: "sans-serif"}}>
      ...
      <a className="ed-button" type="button" href="cabinet5"> Back</a>
    </div>
    </div>
  );
};

export default Plumbing5;